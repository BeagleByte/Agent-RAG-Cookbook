#!/usr/bin/env python3
"""
Full test of AgentNmap.py parsing with the provided XML
"""

import sys
sys.path.insert(0, '/home/argonaut/PycharmProjects/Agent-RAG-Cookbook/OpenWebUI')

from AgentNmap import Tools
...
# Parse the XML
parsed = tools._parse_nmap_xml(xml_data)
...
print("\n\n=== FORMATTED REPORT ===")
report = tools._format_report(parsed)
print(report)
